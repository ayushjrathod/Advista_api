    ...
    conversation = [
        {
            ...
            enough information to generate a under 8 word YouTube search query. If you do, respond ONLY with '[SUFFICIENT]' followed 
            by your suggested under 8 word search query on a new line. Otherwise, ask another relevant question."""
        }
    ]
